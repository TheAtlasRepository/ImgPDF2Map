...
export default function About() {
  return (
    <main className="flex flex-col bg-white dark:bg-gray-800 min-h-screen">
      <Navbar
        activePage="Contact"
      />
      ...
      <div className="flex justify-center p-2 py-5 pt-10">
        <div className="flex flex-col w-1/2 justify-between">
          ...
          <div className="w-100 p-6 card dark:bg-gray-700">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-5 dark:bg-gray-800">
                <div className="mb-4">
                ...
                <div className="flex items-center justify-between">
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline dark:bg-blue-700 dark:hover:bg-blue-900" type="submit">
                    Send
                    </button>
                </div>
            </form>
